...
{
    public abstract class MetaObjectCommandHandlerBase<TCommand, TResult> : CommandHandlerBase<TCommand, TResult>, IDisposable
    {
        ...
        protected MetaObjectCommandHandlerBase(IMainConnectionFactory connectionFactory,
